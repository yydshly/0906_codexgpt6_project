...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'e1', testMatch: ['e1.spec.ts', 'e1-evidence.spec.ts', 'e1-refinement.spec.ts'], timeout: 600000, use: { video: { mode: 'on', size: { width: 1440, height: 900 } }, screenshot: 'only-on-failure' } },
