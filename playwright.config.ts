...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'e1-performance', testMatch: 'e1-performance.spec.ts', timeout: 360000, use: { video: 'off', screenshot: 'off' } },
    { name: 'e1', testMatch: ['e1.spec.ts', 'e1-evidence.spec.ts', 'e1-refinement.spec.ts', 'e1-brush-process.spec.ts'], timeout: 600000, use: { video: { mode: 'on', size: { width: 1440, height: 900 } }, screenshot: 'only-on-failure' } },
